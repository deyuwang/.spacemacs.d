...
values."
  (setq-default
   ...
   ;; `us
	 ...
	 ;; ed-but-keep-unused' installs only the used packages but won't uninstall
...
(custom-set-variables
 ...
 '(custom-safe-themes
	 (quote
		("08b8807d23c290c840bbb14614a83878529359eaba1805618b3be7d61b0b0a32" "66f32da4e185defe7127e0dc8b779af99c00b60c751b0662276acaea985e2721" "ab2cbf30ab758c5e936b527377d543ce4927001742f79519b62c45ba9dd9f55e" default)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:foreground "#ABB2BF" :background "#282C34" :family "Courier" :foundry "nil" :slant normal :weight normal :height 160 :width normal)))))
